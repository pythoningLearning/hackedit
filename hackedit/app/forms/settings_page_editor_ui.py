...
# Form implementation generated from reading ui file '/home/colin/dev/HackEdit/hackedit/data/forms/settings_page_editor.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label_5.setText(_("Default encoding:"))
        self.cb_encoding.setToolTip(_("Default encoding to use when opening files"))
        self.label_10.setText(_("Preferred EOL"))
        self.cb_eol_convention.setToolTip(_("Preferred EOL (will be used for new files and for saving files if auto detect is unchecked)."))
        self.cb_eol_convention.setItemText(0, _("System"))
        self.cb_eol_convention.setItemText(1, _("Linux"))
        self.cb_eol_convention.setItemText(2, _("Mac"))
        self.cb_eol_convention.setItemText(3, _("Windows"))
        self.cb_autodetect_eol.setToolTip(_("Automatically detects file line endings on open and use them for furute saves."))
        self.cb_autodetect_eol.setText(_("Autodetect EOL"))
        self.groupBox_5.setTitle(_("Typing"))
        self.cb_autocomplete.setToolTip(_("Enable automatic completion of quotes, parentheses and brackets."))
        self.cb_autocomplete.setText(_("Enable auto complete (of quotes and parentheses)"))
        self.cb_autoindent.setToolTip(_("Enable/Disable automatic indentation"))
        self.cb_autoindent.setText(_("Enable automatic indentation"))
        self.cb_backspace_unindents.setToolTip(_("Enable/Disable backspaces unindents. If checked, pressing backspace will deintent."))
        self.cb_backspace_unindents.setText(_("Backspace unindents"))
        self.groupBox_2.setTitle(_("Code completion"))
        self.label_3.setText(_("Trigger length:"))
        self.spin_cc_trigger_len.setToolTip(_("<html><head/><body><p>Numbers of character needed in a word to automatically  trigger code completion</p></body></html>"))
        self.label_6.setText(_("Show tooltips:"))
        self.cb_cc_tooltips.setToolTip(_("Show completion tooltip if available"))
        self.label_7.setText(_("Case sensitive:"))
        self.cb_cc_case_sensitive.setToolTip(_("Case sensitive completion"))
        self.label_9.setText(_("Filter mode:"))
        self.cb_cc_filter_mode.setToolTip(_("<html><head/><body><p>Completion filter mode: </p><p>  - Prefix (classic, fast and simple)</p><p>  - Subsequence (fuzzy, slower but more powerful)</p></body></html>"))
        self.cb_cc_filter_mode.setItemText(0, _("Prefix"))
        self.cb_cc_filter_mode.setItemText(1, _("Contains"))
        self.cb_cc_filter_mode.setItemText(2, _("Subsequence"))
        self.groupBox_3.setTitle(_("Open/Save"))
        self.cb_safe_save.setToolTip(_("Use a temporary file for the save, and rename that temporary file to final destination path if everything went right)"))
        self.cb_safe_save.setText(_("Safe save (save to a temporary file first)"))
        self.cb_convert_tabs_to_spaces.setToolTip(_("Convert tabs to spaces on open"))
        self.cb_convert_tabs_to_spaces.setText(_("Convert tabs to spaces"))
        self.cb_restore_cursor.setToolTip(_("Remember and restore previous cursor position on close/open"))
        self.cb_restore_cursor.setText(_("Restore cursor position"))
        self.cb_clean_trailing.setToolTip(_("Clean trailing whitespaces when saving editor content to disk"))
        self.cb_clean_trailing.setText(_("Clean trailing white-spaces"))
        self.groupBox.setTitle(_("Tabs and indentation"))
        self.label_11.setToolTip(_("Use n spaces instead of t"))
        self.label_11.setText(_("Use spaces instead of tabs"))
        self.label.setText(_("Indent size"))
        self.spin_tab_len.setToolTip(_("Number of spaces that makes up a t"))
