...
# Form implementation generated from reading ui file '/home/colin/dev/HackEdit/hackedit/data/forms/settings_page_environment.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox_3.setTitle(_("User Interface"))
        self.label_6.setText(_("Toolbar icon size:"))
        self.spin_toolbar_icon_size.setToolTip(_("Size of the toolbar items"))
        self.label_5.setText(_("Theme:"))
        self.combo_theme.setToolTip(_("Switch between native and dark theme"))
        self.combo_theme.setItemText(0, _("Native"))
        self.combo_theme.setItemText(1, _("Dark"))
        self.cb_system_tray_icon.setToolTip(_("Show/Hide system tray icon (needed to display notifications on Windows and OSX)."))
        self.cb_system_tray_icon.setText(_("Show system tray icon"))
        self.cb_widescreen.setToolTip(_("Use a widescreen layout for the dock widgets (lateral panels will take the whole height of the window)"))
        self.cb_widescreen.setText(_("Use widescreen layout"))
        self.label_7.setText(_("Icon theme:"))
        self.combo_icon_themes.setToolTip(_("Select the icon theme."))
        self.lbl_lang.setText(_("Language:"))
        self.combo_lang.setToolTip(_("<html><head/><body><p>Select the language used by the application. </p><p><span style=\" font-weight:600;\">You\'ll need to restart the application for the change to be applied.</span></p></body></html>"))
        self.group_system.setTitle(_("System commands"))
        self.label_4.setText(_("Run command in terminal:"))
        self.edit_run_command_in_terminal.setToolTip(_("<html><head/><body><p>The command for running a program in an external terminal</p><p>Use %s to indicate file path argument, e.g.: &quot;konsole -e %s&quot;</p></body></html>"))
        self.label.setText(_("Open folder in terminal:"))
        self.edit_open_folder_in_terminal.setToolTip(_("<html><head/><body><p>The command for opening folders in terminal.</p><p>Use %s to indicate file path argument, e.g.: &quot;konsole --workdir %s&quot;</p></body></html>"))
        self.label_2.setText(_("Open in file manager:"))
        self.edit_file_manager.setToolTip(_("<html><head/><body><p>The command for opening files in a file manager.</p><p>Use %s to indicate file path argument, e.g.: &quot;dolphin --select %s&quot;</p></body></html>"))
        self.label_3.setText(_("Open in web browser:"))
        self.cb_use_default_browser.setToolTip(_("<html><head/><body><p>If checked, the system default browser will be used. Otherwise you need to specify the command.</p></body></html>"))
        self.cb_use_default_browser.setText(_("Use system browser"))
        self.groupBox.setTitle(_("Environment variables"))
        self.table.setToolTip(_("<html><head/><body><p>The list of environment variables.</p><p><br/></p></body></html>"))
        self.table.setSortingEnabled(True)
        item = self.table.horizontalHeaderItem(0)
        item.setText(_("Key"))
        item = self.table.horizontalHeaderItem(1)
        item.setText(_("Value"))
        self.bt_add.setToolTip(_("Add an environment variable"))
        self.bt_add.setText(_("..."))
        self.bt_remove.setToolTip(_("Remove the selected environment variable."))
