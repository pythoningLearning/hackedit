...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.edit_interpreter_path = PathLineEdit(self.tab_setup)
        self.edit_interpreter_path.setObjectName("edit_interpreter_path")
        self.horizontalLayout_8.addWidget(self.edit_interpreter_path)
    ...
    def retranslateUi(self, Form):
        ...
        self.edit_interpreter_path.setToolTip(_("Interpreter path or command"))
