...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(self.tab_interpreters)
    ...
    def retranslateUi(self, Form):
        ...
        self.bt_add_interpreter.setToolTip(_("<html><head/><body><p>Add a new compiler</p></body></html>"))
        self.bt_add_interpreter.setText(_("Add"))
        self.bt_clone_interpreter.setToolTip(_("Clone the selected compiler"))
        self.bt_clone_interpreter.setText(_("Clone"))
        self.bt_delete_interpreter.setToolTip(_("Delete the selected compiler"))
        self.bt_delete_interpreter.setText(_("Delete"))
        self.bt_make_default_interpreter.setText(_("Make default"))
        self.bt_check_interpreter.setToolTip(_("Check if the selected compiler works"))
