...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_project.setText(_("Project:"))
        self.cb_project.setToolTip(_("Select project to edit"))
        self.group_configs.setTitle(_("Configurations"))
        self.list_configs.setToolTip(_("List of available run configurations"))
        self.bt_add_cfg.setToolTip(_("Add new configuration"))
        self.bt_rm_cfg.setToolTip(_("Remove selected config"))
        self.group_settings.setTitle(_("Settings"))
        self.label_7.setText(_("Name:"))
        self.edit_name.setToolTip(_("Name of the configuration"))
        self.label.setText(_("Script:"))
        self.edit_script.setToolTip(_("Path to the script to run"))
        self.bt_pick_script.setToolTip(_("Choose script"))
        self.bt_pick_script.setText(_("..."))
        self.label_2.setText(_("Script parameters:"))
        self.edit_script_args.setToolTip(_("Script paramters"))
        self.label_5.setText(_("Working directory:"))
        self.edit_working_dir.setToolTip(_("Working directory"))
        self.bt_pick_working_dir.setToolTip(_("Choose working dir"))
        self.bt_pick_working_dir.setText(_("..."))
        self.label_4.setText(_("Interpreter options:"))
        self.edit_intepreter_options.setToolTip(_("Interpreter options"))
        self.label_6.setText(_("Environment variables"))
        self.table_env_vars.setToolTip(_("Environment variables to set on the run process"))
        ...
        self.bt_add_env_var.setToolTip(_("Add a new environment variable"))
