...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.mnu_file.setTitle(_("Fi&le"))
        ...
        self.mnu_edit.setTitle(_("E&dit"))
        ...
        self.action_report_bug.setText(_("&Report an issue..."))
        self.action_report_bug.setToolTip(_("Create an issue (report a bug/enhancement)"))
