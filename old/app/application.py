...
def get_style_by_name(name):
    try:
        ...
        if name == 'qt':
            ...
            from hackedit.presentation.styles.aube import AubeStyle
            style = AubeStyle
        elif name == 'crepuscule':
            from hackedit.presentation.styles.crepuscule import CrepusculeStyle
            style = CrepusculeStyle
        elif name == 'ark-dark':
            from hackedit.presentation.styles import ArkDarkStyle
            style = ArkDarkStyle
        else:
            raise e
    finally:
