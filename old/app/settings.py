...
IGNORE_PATTERNS_STR = ';'.join(DEFAULT_IGNORE_PATTERNS).split(';')
...
def load_compiler_configurations():
    from old.api.compiler import CompilerConfig
...
def load_pre_compiler_configurations():
    from old.api.pre_compiler import PreCompilerConfig
...
def load_interpreter_configurations():
    from old.api.interpreter import InterpreterConfig
